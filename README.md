About robocorp-workitems-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/robocorp-workitems-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/robocorp-workitems-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add robocorp-workitems
# for installing globally
pixi global install robocorp-workitems
```
...
It is possible to list all of the versions of `robocorp-workitems` available on your platform:
...
```
pixi search robocorp-workitems --channel conda-forge
```
